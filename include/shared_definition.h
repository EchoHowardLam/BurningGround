...
#define DMG_STANDARD_DEMON_DAMAGE 300
...
#define DMG_STANDARD_ICESPIKE_DAMAGE 1
#define DMG_STANDARD_FIRELASER_DAMAGE 100
#define DMG_STANDARD_ICELASER_DAMAGE 90
...
typedef enum { NOTHING = 0,
			   ...
			   LIFE_MUSHROOM, LIFE_RABBIT, LIFE_SLUDGE, LIFE_SLIME,
			   ...
			   PROFESSOR_HTRAHDIS, ESTR_MEMORY,
