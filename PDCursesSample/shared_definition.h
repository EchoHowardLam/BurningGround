...
#define DMG_STANDARD_MOSQUITO_DAMAGE 1
#define DMG_STANDARD_BEE_DAMAGE 2
#define DMG_STANDARD_SLUDGE_MELEE_DAMAGE 1
...
#define DMG_STANDARD_FIRELASER_DAMAGE 2
#define DMG_STANDARD_ICELASER_DAMAGE 1
